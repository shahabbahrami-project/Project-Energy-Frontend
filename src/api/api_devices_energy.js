...
export const getDevicesType = (callback) => {
  getAxiosInstanceApiEnergy()
    .get("/api/sites/devicetypes/")
    .then((response) => {
...
export const updateDevice = (device, id, callback) => {
  getAxiosInstanceApiEnergy()
    .put("/api/sites/devices/" + String(id) + "/", device)
    .then((response) => {
      const data = response.data;
      callback(true, data);
    })
...
export const deleteDevice = (id, callback) => {
  getAxiosInstanceApiEnergy()
    .delete("/api/sites/devices/" + String(id) + "/")
    .then((response) => {
      const data = response.data;
      callback(true, data);
    })
...
export const sensorsdata = (historyGraph, callback) => {
  getAxiosInstanceApiEnergy()
    .post("/api/sites/historydata/", historyGraph)
    .then((response) => {
      const data = response.data;
      callback(true, data);
    })
...
export const sensorsonlinedata = (props, callback) => {
  getAxiosInstanceApiEnergy()
    .post(
      `/api/sites/onlinedata/${props.clickedDevice.id}`,
