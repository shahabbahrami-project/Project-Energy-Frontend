...
const Sites = () => {
          ...
          <Marker position={marker} icon={custommarker}>
            <Popup minWidth={360} >
              ...
              <Typography variant="boddy1" gutterBottom>
                {"Name: " + addSite.features.name}<br />
                {"Building: " + addSite.features.building}<br />
                {"Location: " + "[" + " X: " + addSite.features.locationX + ", Y: " + addSite.features.locationY + " ]"}<br />
                {"Sensor or Smart Meter: " + addSite.features.sensorOrmeter}
              </Typography>
            ...
            <Marker position={[item.locationY, item.locationX]} icon={originalicon}
              eventHandlers={{
                click: (e) => {
                  ...
                  setClickedSite(sites.find(element => element.locationY == lat_clicked && element.locationX == long_clicked));
                },
                mouseover: (e) => {
                  e.target.setIcon(hovericon)
                },
  ...
  return (
    <>
      <PageTitle title="Measurements Map" />
